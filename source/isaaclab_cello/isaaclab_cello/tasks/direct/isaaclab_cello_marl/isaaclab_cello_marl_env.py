...
from .isaaclab_cello_marl_env_cfg import IsaaclabCelloMarlEnvCfg


class IsaaclabCelloMarlEnv(DirectMARLEnv):
    cfg: IsaaclabCelloMarlEnvCfg

    def __init__(self, cfg: IsaaclabCelloMarlEnvCfg, render_mode: str | None = None, **kwargs):
